...
public class MainUI {
	...
	public static void main(String[] args) {
		...
		System.out.println(service.findByDay("Mon"));
		System.out.println(service.findByDay("Tue"));
		
		/*SportsService s1=contex.getBean("service",SportsService.class);
		SportsService s2=contex.getBean("service",SportsService.class);
		SportsService s3=contex.getBean("service",SportsService.class);
